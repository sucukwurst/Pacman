...
public class TRYKI
{
    ...
    private int UO;
    private int LR;
    public TRYKI(int column, int row)
    {
        terr = new Territory("feld1.ter");
        pac = terr.getPacman(0);
        /*pac1=new Hamster(terr,8, 3,Direction.EAST, 0);*/
        /*pac1=new Hamster(terr,4, 6,Direction.EAST, 0);*/
        /*pac1=new Hamster(terr,8, 5,Direction.EAST, 0);*/
        pac1=new Pacman(terr,column, row,Direction.EAST, 0);
        GameField=new char[10][8];
        for(int x=0; x<10; x++){
            for(int y=0; y<8; y++){
